...
def calculate_demographic_data(print_data=True):
    ...
    lower_education = df[~(df['education'].isin(higher_ed_names))]
    ...
    lower_education_rich = round(lower_education[lower_education['salary'] == '>50K'].shape[0]/total_lower_ed *100, 1)
